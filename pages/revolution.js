  ...
  return (
    <Grid container direction="column">
        ...
        <Grid item container direction="column" lg style={{ maxWidth: "40em" }}>
          ...
          <Grid item>
            ...
            >
              ...
              rebuilt using React. Developers have since built on top of these
              systems by automating project setup and deployment, allowing
              creators to focus as much as possible on their work itself. These
              technical advancements translate into savings by significantly
              ...
              for mobile app development. This puts personalization in your
              pocket — faster, better, and more affordable than ever before.
            </Typography>
          </Grid>
          <Grid item>
            <Typography
          ...
          <Grid item>
            ...
            >
              ...
              barrier to entry for mobile app development. This puts
              personalization in your pocket — faster, better, and more
      ...
      <Grid
        ...
        direction={matchesMD ? "column" : "row"}
        className={classes.rowContainer}
        style={{ backgroundColor: "#A67C62", height: "90em" }}
      >
        <Grid
          item
          container
